...
Most of these come down to network reality or how ncbi serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

ncbi rate-limits like any public site. ncbi already paces
...
Where a surface is gated, ncbi reads a cookie or token you supply
...
`ncbi`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what ncbi actually did
