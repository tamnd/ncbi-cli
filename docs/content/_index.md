---
title: "ncbi"
description: "A command line for ncbi."
heroTitle: "ncbi, from the command line"
heroLead: "A command line for ncbi. One pure-Go binary, no API key, output that pipes into the rest of your tools, and a resource-URI driver other programs can address."
...
ncbi links <path>           # the pages it links to, each addressable
ncbi serve --addr :7777     # the same operations over HTTP
```
...
- **As a command** for reading ncbi by hand or in a script. Start with
  the [quick start](/getting-started/quick-start/).
- **As a resource-URI driver** so a host like
  [ant](https://github.com/tamnd/ant) can address ncbi as
  `ncbi://` URIs and follow links across sites. See
