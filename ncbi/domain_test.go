...
func TestHostWiring(t *testing.T) {
	...
	if want := "ncbi://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("ncbi", "about")
	if err != nil || got.String() != "ncbi://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want ncbi://page/about", got.String(), err)
	}
}
